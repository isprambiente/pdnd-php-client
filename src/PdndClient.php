...
class PdndClient
{
    ...
    */
    ...
    public function setPurposeId(string $purposeId)
    {
        $this->purposeId = $purposeId;
    }
    public function setPrivKeyPath(string $privKeyPath)
    {
    ...
    public function setVerifySSL(string $verifySSL)
    {
    ...
    public function getPrivKeyPath()
    {
